 ...
 *
 * <p>It encodes in base64 everything passed to the stream, and it puts the encoded data into the
 * underlying stream.
 *
...
public class Base64OutputStream extends OutputStream {
  ...
  /**
   * It builds a base64 encoding output stream writing the encoded data in the given underlying
   * stream.
   *
   * <p>The encoded data is wrapped to a new line (with a CRLF sequence) every 76 bytes sent to the
   * underlying stream.
   *
   ...
   * stream.
   *
   * <p>The encoded data is wrapped to a new line (with a CRLF sequence) every <em>wrapAt</em> bytes
   * sent to the underlying stream. If the <em>wrapAt</em> supplied value is less than 1 the encoded
   * data will not be wrapped.
   *
   * @param outputStream The underlying stream.
